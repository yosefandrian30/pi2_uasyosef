        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="card" style="width: 60rem; padding: 20px 20px 20px 20px; margin:auto;">
                    <div class="mt-3">
                        <form action="<?= base_url('admin/simpankeahlian') ?>" method="POST">
                            <div class="mb-3">
                                <label for="exampleFormControlInput1" class="form-label">Keahlian</label>
                                <input type="text" name="nama_keahlian" class="form-control" id="exampleFormControlInput1" placeholder="keahlian">
                            </div>
                            <div class="mb-3">
