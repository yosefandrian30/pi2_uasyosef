                ...
                <div class="card" style="width: 90rem; padding: 20px 20px 20px 20px; margin:auto;">
                    <div class="card-body">
                        ...
                        <div class="col-md-10 mt-3">
                            <div class="row mt-5">
                                <div class="col-5">
                                    <a href="<?= base_url('admin/create_keahlian') ?>" class="btn btn-success">Tambah</a>
                                </div>
                            </div>
                            ...
                            <table class="table mt-3">
                                ...
                                <tbody>
                                    <?php
                                    foreach ($allkeahlian as $no => $keahlian) {
                                    ?>
                                        <tr>
                                            <th scope="row"><?= $no + 1 ?></th>
                                            <td><?= $keahlian['nama_keahlian']; ?></td>
                                            <td>
                                                <a href="<?= base_url('admin/edit_keahlian/' . $keahlian['keahlian_id']) ?>" class="btn btn-warning">Edit</a>
                                                <a href="<?= base_url('admin/hapuskeahlian/' . $keahlian['keahlian_id']) ?>" class="btn btn-danger">Hapus</a>
                                            </td>
                                        </tr>
                                    <?php
                                    }
