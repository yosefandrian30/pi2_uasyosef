                ...
                <div class="card" style="width: 90rem; padding: 20px 20px 20px 20px; margin:auto;">
                    <div class="card-body">
                        ...
                        <div class="col-md-10 mt-3">
                            <div class="row mt-5">
                                <div class="col-5">
                                    <a href="<?= base_url('admin/create_pendidikan') ?>" class="btn btn-success">Tambah</a>
                                </div>
                            </div>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?= base_url('admin/edit_pendidikan/' . $pendidikan['pendidikan_id']) ?>" class="btn btn-warning">Edit</a>
                                                <a href="<?= base_url('admin/hapuspendidikan/' . $pendidikan['pendidikan_id']) ?>" class="btn btn-danger">Hapus</a>
                                            </td>
                                        </tr>
                                    <?php
                                    }
