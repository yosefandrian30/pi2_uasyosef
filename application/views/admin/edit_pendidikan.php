                ...
                <div class="card" style="width: 60rem; padding: 20px 20px 20px 20px; margin:auto;">
                    <div class="mt-3">
                        <form action="<?= base_url('admin/editpendidikan') ?>" method="POST">
                            <input type="hidden" name="pendidikan_id" value="<?= $pendidikan['pendidikan_id'] ?>" <div class="mb-3">
                            <label for="exampleFormControlInput1" class="form-label">Tahun</label>
                            <input type="text" name="tahun" class="form-control" id="exampleFormControlInput1" placeholder="tahun" value="<?= $pendidikan['tahun'] ?>">
                    </div>
                    <div class="mb-3">
                        <label for="exampleFormControlInput1" class="form-label">Nama Instansi</label>
                        <input type="text" name="nama_instansi" class="form-control" id="exampleFormControlInput1" placeholder="nama instansi" value="<?= $pendidikan['nama_instansi'] ?>">
                    </div>
                    <div class="mb-3">
